...
CREATE TABLE `post_record`(PostID int NOT NULL, Posttype TEXT (65535) NOT NULL, Postname TEXT (100) NOT NULL, Postcontent TEXT (65535) NOT NULL, Postimage longblob NOT NULL, Posttime TIMESTAMP NOT NULL, UserID int NOT NULL, FOREIGN KEY (UserID) REFERENCES user(UserID));
...
-- table post record
INSERT INTO post_record VALUES (00001, 'PolyU Life', 'Handsome guy Gabriel', 'Gabriel, the most handsome guy in comp department, trust me!', 0,'2023-03-25 07:52:11', 00014);
INSERT INTO post_record VALUES (00002, 'Faculty News', 'Winnie is getting Microsoft Azure Offer!!!', 'Congrats', 0,'2023-03-25 09:30:55', 00005);
INSERT INTO post_record VALUES (00003, 'PolyU Life', 'I am getting 1.7 gpa', 'Who can carry me!!!!!!!', 0,'2023-03-25 09:52:46', 00011);
INSERT INTO post_record VALUES (00004, 'PolyU Life', 'Daniel Yu is nto having offer from microsoft', 'Can someone comfort me...', 0,'2023-03-25 10:56:55', 00012);
